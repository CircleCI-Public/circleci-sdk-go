...
func (a *WorkflowApiService) RerunWorkflow(ctx context.Context, id string, localVarOptionals *WorkflowApiRerunWorkflowOpts) (InlineResponse202, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
