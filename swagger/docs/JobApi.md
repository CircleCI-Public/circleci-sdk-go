...
------------- | ------------- | -------------
[**CancelJobByJobID**](JobApi.md#CancelJobByJobID) | **Post** /jobs/{job-id}/cancel | Cancel job by job ID
[**CancelJobByJobNumber**](JobApi.md#CancelJobByJobNumber) | **Post** /project/{project-slug}/job/{job-number}/cancel | Cancel job by job number
...
# **CancelJobByJobID**
> MessageResponse CancelJobByJobID(ctx, jobId)
 ...
 **ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
  **jobId** | [**string**](.md)| The unique ID of the job. | 
...
> MessageResponse CancelJobByJobNumber(ctx, jobNumber, projectSlug)
